...
function addIntervention(
    ...
    if (
        ...
        //Define o status da intervenção que está sendo cadastrada como falso
        var status = false;
        ...
        for (let index in data) {
            ...
            if (data[index].status == true || data[index].status == "true") {
                ...
                if (isInInterval) {
                    ...
                    // console.log(
                    //     "Origin Street: " +
                    //         data[index].origin.street +
                    //         "\nDestination Street: " +
                    //         data[index].destination.street
                    // );
                }
            } else {
