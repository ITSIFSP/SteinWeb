...
class UserController extends Controller
{
    ...
    public function updatePassword(Request $request)
    {
        if ($request->password == $request->password_confirmation) {
            ...
            if ($updatePassword)
                return redirect(url('/'));
            return redirect()->back()->with('error', 'Ocorreu um erro ao atualizar sua senha, contate o administrador do sistema!');
        } else {
            return back();
        }
